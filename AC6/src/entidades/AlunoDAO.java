...
import java.util.Scanner;
    ...
    public class AlunoDAO {
        ...
        public void adicionarAluno(Scanner leitor) {
            ...
            if (matricula.equals("")){
                System.out.print("Opção Invalida! Digite a matrícula do aluno novamente: ");
                matricula = leitor.nextLine();
            }
            System.out.print("Digite o nome do aluno: ");
            String nome = leitor.nextLine();
            if (nome.equals("")){
                System.out.print("Opção Invalida! Digite o nome do aluno novamente: ");
                nome = leitor.nextLine();
            }
            System.out.print("Digite o curso do aluno: ");
            String curso = leitor.nextLine();
            if (curso.equals("")){
                System.out.print("Opção Invalida! Digite o curso do aluno novamente: ");
        ...
        public void atualizarCurso(Scanner leitor) {
            ...
            for (Aluno aluno : alunos) {
                if (aluno.getMatricula().equals(matricula)) {
                    ...
                    if (novoCurso.equals("")){
                    System.out.print("Opção Invalida! Digite o novo curso do aluno novamente: ");
                    novoCurso = leitor.nextLine();
            }
